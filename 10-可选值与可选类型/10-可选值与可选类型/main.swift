...
*/
var optValue5 : Int? = 5
var result : Int = optValue5!
print("result:",result)

//下面强制解析空值,报错
var optValue6 : Int?
//var result1 : Int = optValue6!
...
var test1 = Test1()
test1.num1 = 12
print("test1-----",test1.num1!)

var test2 = Test1()
test2.num1 = 13
print("test2-----",test2.num1!)

test1 = test2
test2.num1 = 33
print("test1-----",test1.num1!) //33

test1.num1 = 44
print("test2-----",test2.num1!) //44
